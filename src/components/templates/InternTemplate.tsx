...
const InternTemplate = ({ 
  ...
  return (
    <div className={`max-w-4xl mx-auto bg-white p-8 shadow-lg min-h-[297mm] resume-wrapper ${isPDFMode ? 'tight-spacing' : ''}`}>
      {/* Intern Header */}
      <header className="text-center bg-gradient-to-r from-green-500 to-blue-600 text-white p-8 rounded-lg mb-8 no-break">
      ...
      {personalInfo?.summary && (
        <section className="mb-8 no-break">
          ...
          <div className="text-gray-700 leading-relaxed bg-green-50 p-6 rounded-lg border-l-4 border-green-500">
            <EditableText
              ...
              placeholder="Your career goals and what you hope to learn"
            />
          </div>
        </section>
      )}
      ...
      {education?.length > 0 && (
        <section className="mb-8 section-break">
          <h2 className="text-xl font-bold text-green-600 mb-6 border-b-2 border-green-300 pb-2">
            Education
          </h2>
          <div className="space-y-6">
            {education.map((edu: any, index: number) => (
              <div key={index} className="bg-green-50 p-6 rounded-lg border border-green-200 no-break">
        ...
        <section className="mb-8 section-break">
          ...
          <div className="space-y-6">
            {experience.map((exp: any, index: number) => (
              <div key={index} className="border-l-4 border-green-400 pl-6 allow-break">
                <div className="flex justify-between items-start mb-2">
                  <div>
                    <h3 className="text-lg font-bold text-gray-900">
                      <EditableText
                ...
                <div className="text-gray-700 leading-relaxed whitespace-pre-line">
                  <EditableText
                    ...
                    isEditing={isEditing}
                    className="inline-block w-full"
                    placeholder="Key responsibilities and learning outcomes"
                  />
                </div>
              </div>
            ))}
              ...
              <div key={index} className="bg-green-50 p-6 rounded-lg border border-green-200 allow-break">
                ...
                <div className="text-gray-700 leading-relaxed whitespace-pre-line">
                  <EditableText
                    ...
                    isEditing={isEditing}
                    className="inline-block w-full"
                    placeholder="Project description and skills demonstrated"
                  />
                </div>
        ...
        <section className="mb-8 no-break">
          ...
          <div className="grid grid-cols-2 gap-4">
            {skills.map((skill: string, index: number) => (
              <div key={index} className="flex items-center bg-green-100 text-green-800 px-4 py-3 rounded-lg">
