...
const MediaTemplate = ({ 
  ...
  return (
    <div className={`max-w-4xl mx-auto bg-white p-8 shadow-lg min-h-[297mm] resume-wrapper ${isPDFMode ? 'tight-spacing' : ''}`}>
      {/* Media Header */}
      <header className="bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 text-white p-8 rounded-lg mb-8 no-break">
          ...
          <div className="flex items-center justify-center mb-4">
            ...
            <h1 className="text-4xl font-bold">
              <EditableText
                ...
                placeholder="Media Professional"
                isEditing={isEditing}
      ...
      {personalInfo?.summary && (
        <section className="mb-8 no-break">
          ...
          <div className="text-gray-700 leading-relaxed bg-gradient-to-r from-indigo-50 to-purple-50 p-6 rounded-lg border border-indigo-200">
            <EditableText
              ...
              placeholder="Your creative vision and media expertise"
            />
          </div>
        </section>
      )}
      ...
      {experience?.length > 0 && (
        <section className="mb-8 section-break">
          <h2 className="text-xl font-bold text-indigo-600 mb-6 border-b-2 border-indigo-300 pb-2">
            Media & Creative Experience
          </h2>
          <div className="space-y-6">
            {experience.map((exp: any, index: number) => (
              <div key={index} className="relative pl-8 allow-break">
                <div className="absolute left-0 top-2 w-6 h-6 bg-gradient-to-r from-indigo-500 to-purple-500 rounded-full flex items-center justify-center">
                  <Camera className="w-3 h-3 text-white" />
                </div>
                <div className="absolute left-3 top-8 w-0.5 h-full bg-indigo-200"></div>
                ...
                <div className="flex justify-between items-start mb-2">
                  ...
                  <span className="text-gray-600 font-medium bg-indigo-100 px-3 py-1 rounded-full">
                    <EditableText
                      value={exp.startDate || ''}
                ...
                <div className="text-gray-700 leading-relaxed whitespace-pre-line">
                  <EditableText
                    ...
                    isEditing={isEditing}
                    className="inline-block w-full"
                    placeholder="Creative projects and media production achievements"
                  />
                </div>
              </div>
            ))}
        ...
        <section className="mb-8 section-break">
          ...
          <div className="space-y-6">
            {projects.map((project: any, index: number) => (
              <div key={index} className="bg-gradient-to-r from-indigo-50 to-purple-50 p-6 rounded-lg border border-indigo-200 allow-break">
                ...
                <div className="text-gray-700 leading-relaxed whitespace-pre-line">
                  <EditableText
                    ...
                    isEditing={isEditing}
                    className="inline-block w-full"
                    placeholder="Creative concept and production details"
                  />
                </div>
