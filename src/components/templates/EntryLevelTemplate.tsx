    ...
    <div className={`max-w-4xl mx-auto bg-white p-8 shadow-lg min-h-[297mm] resume-wrapper ${isPDFMode ? 'tight-spacing' : ''}`}>
          ...
          {personalInfo?.email && (
            <div className="flex items-center justify-center">
              ...
              <EditableText
                ...
                isEditing={isEditing}
                className="inline-block text-white"
                placeholder="email@graduate.com"
              />
            </div>
          )}
          {personalInfo?.phone && (
      ...
      {personalInfo?.summary && (
        <section className="mb-8 no-break">
          ...
          <div className="text-gray-700 leading-relaxed bg-blue-50 p-6 rounded-lg border-l-4 border-blue-500">
            <EditableText
              ...
              placeholder="Your career goals and what you bring to employers"
            />
          </div>
        </section>
      )}
                  ...
                  <div>
                    <h3 className="text-lg font-bold text-gray-900">
                      <EditableText
                        ...
                        isEditing={isEditing}
                        className="inline-block"
                        placeholder="Position/Internship"
                      />
                    </h3>
                    <p className="text-blue-600 font-semibold">
                      <EditableText
